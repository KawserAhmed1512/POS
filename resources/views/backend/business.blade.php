...
<h1> Business Setting or Information </h1>
...
@csrf
  ...
  <div class="form-group" style="margin-top: 10px;">
   ...
   <input value="" class="form-control" type="text" name="facebook_link" id="" placeholder="Enter facebook link">
  </div>


  <div class="form-group" style="margin-top: 10px;">
    <label for="">Enter Contact Number</label>
   <input  value="" class="form-control" type="number" name="contact" id="" placeholder="Enter contact number">
  </div>
