    ...
    <div class="col-lg-2 col-sm-6">
      <div class="circle-tile ">
        ...
        <div class="circle-tile-content dark-blue">
          ...
          <div class="circle-tile-number text-faded ">{{$allCustomerCount}}</div>
          <a class="circle-tile-footer" href="{{route('customer')}}">More Info<i class="fa fa-chevron-circle-right"></i></a>
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-2 col-sm-6">
      <div class="circle-tile ">
        ...
        <div class="circle-tile-content red">
          <div class="circle-tile-description text-faded"> Total Order Item List</div>
          <div class="circle-tile-number text-faded ">{{$allOrderCount}}</div>
          <a class="circle-tile-footer" href="{{route('order.entry')}}">More Info<i class="fa fa-chevron-circle-right"></i></a>
        </div>
      </div>
    </div> 
    ...
    <div class="col-lg-2 col-sm-6">
      <div class="circle-tile ">
        ...
        <div class="circle-tile-content yellow">
          ...
          <div class="circle-tile-number text-faded ">{{$allProductCount}}</div>
